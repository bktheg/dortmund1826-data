...
<qgis simplifyLocal="1" version="3.28.8-Firenze" minScale="100000000" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyAlgorithm="0" labelsEnabled="1" simplifyDrawingHints="1" symbologyReferenceScale="-1" simplifyDrawingTol="1" simplifyMaxScale="1" readOnly="0">
  ...
  <labeling type="rule-based">
    <rules key="{4fc77055-40e9-48b4-96ed-ee64baa4d2c3}">
      <rule key="{64dbc88c-7645-4b4f-91a2-d893915a477f}" scalemaxdenom="2000" scalemindenom="1">
        <settings calloutType="simple">
          <text-style fontWordSpacing="0" textColor="0,0,0,255" forcedBold="0" forcedItalic="0" fontSize="4" useSubstitutions="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" blendMode="0" legendString="Aa" fieldName="name" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" textOpacity="1" multilineHeight="1" fontKerning="1" fontWeight="50" fontUnderline="0" multilineHeightUnit="Percentage" fontLetterSpacing="1.5" namedStyle="Standard" allowHtml="0" fontSizeUnit="MapUnit" fontFamily="MS Shell Dlg 2" textOrientation="horizontal" capitalization="0" isExpression="0">
            <families/>
          ...
          <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" repeatDistanceUnits="MapUnit" quadOffset="4" polygonPlacementFlags="2" overrunDistanceUnit="MM" lineAnchorType="0" maxCurvedCharAngleOut="-25" priority="5" maxCurvedCharAngleIn="25" geometryGeneratorType="PointGeometry" placement="3" preserveRotation="1" layerType="LineGeometry" offsetUnits="MapUnit" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" placementFlags="9" centroidInside="0" distUnits="MM" allowDegraded="0" overlapHandling="PreventOverlap" geometryGenerator="" lineAnchorTextPoint="CenterOfText" lineAnchorPercent="0.5" xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="150" rotationUnit="AngleDegrees" yOffset="0" geometryGeneratorEnabled="0" rotationAngle="0" offsetType="0" overrunDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0"/>
          <rendering maxNumLabels="2000" obstacleFactor="1" scaleMax="10000000" scaleMin="1" fontMaxPixelSize="10000" mergeLines="0" labelPerPart="0" obstacle="0" fontLimitPixelSize="1" unplacedVisibility="0" scaleVisibility="0" limitNumLabels="0" obstacleType="0" upsidedownLabels="0" drawLabels="1" fontMinPixelSize="3" zIndex="0" minFeatureSize="1"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties"/>
      ...
      <rule key="{cb6ebe17-3e47-4f67-a551-27bb4b541149}" scalemaxdenom="16000" scalemindenom="2000">
        <settings calloutType="simple">
          ...
          <text-format wrapChar="" rightDirectionSymbol=">" addDirectionSymbol="0" placeDirectionSymbol="0" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" useMaxLineLengthForAutoWrap="1" autoWrapLength="0" plussign="0" decimals="3" multilineAlign="0"/>
          <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" repeatDistanceUnits="MapUnit" quadOffset="4" polygonPlacementFlags="2" overrunDistanceUnit="MM" lineAnchorType="0" maxCurvedCharAngleOut="-25" priority="5" maxCurvedCharAngleIn="25" geometryGeneratorType="PointGeometry" placement="3" preserveRotation="1" layerType="LineGeometry" offsetUnits="MapUnit" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" placementFlags="9" centroidInside="0" distUnits="MM" allowDegraded="0" overlapHandling="PreventOverlap" geometryGenerator="" lineAnchorTextPoint="CenterOfText" lineAnchorPercent="0.5" xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="300" rotationUnit="AngleDegrees" yOffset="0" geometryGeneratorEnabled="0" rotationAngle="0" offsetType="0" overrunDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0"/>
          <rendering maxNumLabels="2000" obstacleFactor="1" scaleMax="10000000" scaleMin="1" fontMaxPixelSize="10000" mergeLines="0" labelPerPart="0" obstacle="0" fontLimitPixelSize="1" unplacedVisibility="0" scaleVisibility="0" limitNumLabels="0" obstacleType="0" upsidedownLabels="0" drawLabels="1" fontMinPixelSize="3" zIndex="0" minFeatureSize="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
  ...
  <DiagramLayerSettings zIndex="0" placement="2" linePlacementFlags="2" priority="0" obstacle="0" showAll="1" dist="0">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="Fluss" value="1" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Straße" value="{2839923C-8B7D-419E-B84B-CA2FE9B80EC7}" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Lagebezeichnung" value="2" type="QString"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias name="" field="flur" index="4"/>
    <alias name="" field="type" index="5"/>
    <alias name="" field="anmerkung" index="6"/>
  </aliases>
  <defaults>
    ...
    <default field="anmerkung" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint exp_strength="0" field="anmerkung" unique_strength="0" constraints="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="anmerkung" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column name="anmerkung" hidden="0" width="-1" type="field"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorField name="flur" showLabel="1" index="4">
      <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont description="MS Shell Dlg 2,8.14286,-1,5,50,0,0,0,0,0" underline="0" bold="0" italic="0" strikethrough="0" style=""/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField name="name" showLabel="1" index="2">
      <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont description="MS Shell Dlg 2,8.14286,-1,5,50,0,0,0,0,0" underline="0" bold="0" italic="0" strikethrough="0" style=""/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField name="type" showLabel="1" index="5">
      <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont description="MS Shell Dlg 2,8.14286,-1,5,50,0,0,0,0,0" underline="0" bold="0" italic="0" strikethrough="0" style=""/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField name="anmerkung" showLabel="1" index="6">
      <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont description="MS Shell Dlg 2,8.14286,-1,5,50,0,0,0,0,0" underline="0" bold="0" italic="0" strikethrough="0" style=""/>
      </labelStyle>
    </attributeEditorField>
  ...
  <editable>
    <field name="anmerkung" editable="1"/>
    <field name="flur" editable="1"/>
    <field name="gemeinde" editable="1"/>
    <field name="id" editable="1"/>
    <field name="jahrbis" editable="1"/>
    <field name="jahrvon" editable="1"/>
