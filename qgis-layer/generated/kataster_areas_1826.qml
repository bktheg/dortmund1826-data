...
<qgis simplifyLocal="1" version="3.28.8-Firenze" minScale="100000000" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyAlgorithm="0" labelsEnabled="1" simplifyDrawingHints="1" symbologyReferenceScale="-1" simplifyDrawingTol="1" simplifyMaxScale="1" readOnly="0">
  <renderer-3d layer="kataster_areas_1826_2fd8f686_bf51_4beb_ab63_52444283d557" type="rulebased">
    ...
    <rules key="{e61cbe7c-3e6f-417d-bcba-96116f0521d5}">
      <rule filter="typ=0" key="{63297c0b-b627-4d08-8fae-00cc0b0e5990}">
    ...
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" name="2" frame_rate="10" type="fill" force_rhr="0" is_animated="0">
        ...
        <layer pass="0" class="PointPatternFill" locked="0" enabled="1">
          ...
          <symbol alpha="1" clip_to_extent="1" name="@2@1" frame_rate="10" type="marker" force_rhr="0" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="3" frame_rate="10" type="fill" force_rhr="0" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="4" frame_rate="10" type="fill" force_rhr="0" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="5" frame_rate="10" type="fill" force_rhr="0" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="6" frame_rate="10" type="fill" force_rhr="0" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="7" frame_rate="10" type="fill" force_rhr="0" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="8" frame_rate="10" type="fill" force_rhr="0" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="9" frame_rate="10" type="fill" force_rhr="0" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{1917aba4-ea04-49e8-be42-304988bea9d4}">
      <rule filter="typ is null or typ = 0" key="{b03fa263-6b65-47c6-93e1-fd49a2940337}" scalemaxdenom="10000" scalemindenom="400">
        <settings calloutType="simple">
          <text-style fontWordSpacing="0" textColor="7,11,157,255" forcedBold="0" forcedItalic="0" fontSize="3" useSubstitutions="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" blendMode="0" legendString="Aa" fieldName="flur || '-' || nr" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" textOpacity="1" multilineHeight="1" fontKerning="1" fontWeight="63" fontUnderline="0" multilineHeightUnit="Percentage" fontLetterSpacing="0" namedStyle="Semibold" allowHtml="0" fontSizeUnit="RenderMetersInMapUnits" fontFamily="Open Sans" textOrientation="horizontal" capitalization="0" isExpression="1">
            <families/>
            <text-buffer bufferJoinStyle="128" bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferSizeUnits="RenderMetersInMapUnits" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferNoFill="1" bufferSize="0.29999999999999999"/>
          ...
          <text-format wrapChar="" rightDirectionSymbol=">" addDirectionSymbol="0" placeDirectionSymbol="0" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" useMaxLineLengthForAutoWrap="1" autoWrapLength="0" plussign="0" decimals="3" multilineAlign="0"/>
          <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" repeatDistanceUnits="MM" quadOffset="4" polygonPlacementFlags="2" overrunDistanceUnit="MM" lineAnchorType="0" maxCurvedCharAngleOut="-25" priority="5" maxCurvedCharAngleIn="25" geometryGeneratorType="PointGeometry" placement="1" preserveRotation="1" layerType="PolygonGeometry" offsetUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" placementFlags="10" centroidInside="1" distUnits="MM" allowDegraded="0" overlapHandling="PreventOverlap" geometryGenerator="" lineAnchorTextPoint="CenterOfText" lineAnchorPercent="0.5" xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" rotationUnit="AngleDegrees" yOffset="0" geometryGeneratorEnabled="0" rotationAngle="0" offsetType="0" overrunDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0"/>
          <rendering maxNumLabels="2000" obstacleFactor="1" scaleMax="0" scaleMin="0" fontMaxPixelSize="10000" mergeLines="0" labelPerPart="0" obstacle="1" fontLimitPixelSize="0" unplacedVisibility="0" scaleVisibility="0" limitNumLabels="0" obstacleType="0" upsidedownLabels="0" drawLabels="1" fontMinPixelSize="3" zIndex="0" minFeatureSize="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties"/>
      ...
      <rule filter="typ is null or typ = 0" key="{1842baeb-4f48-4460-929c-f3f8ee590ade}" scalemaxdenom="400" scalemindenom="1">
        <settings calloutType="simple">
          <text-style fontWordSpacing="0" textColor="7,11,157,255" forcedBold="0" forcedItalic="0" fontSize="1" useSubstitutions="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" blendMode="0" legendString="Aa" fieldName="flur || '-' || nr || '###'  || COALESCE(eigentuemer,'') || '###' || COALESCE(flaeche,'') || ' ' || COALESCE(typPlain,'')" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" textOpacity="1" multilineHeight="1" fontKerning="1" fontWeight="63" fontUnderline="0" multilineHeightUnit="Percentage" fontLetterSpacing="0" namedStyle="Semibold" allowHtml="0" fontSizeUnit="RenderMetersInMapUnits" fontFamily="Open Sans" textOrientation="horizontal" capitalization="0" isExpression="1">
            <families/>
            <text-buffer bufferJoinStyle="128" bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferSizeUnits="RenderMetersInMapUnits" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferNoFill="1" bufferSize="0.10000000000000001"/>
            <text-mask maskSize="0" maskedSymbolLayers="" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskEnabled="0" maskSizeUnits="MM" maskJoinStyle="128"/>
            <background shapeDraw="0" shapeSizeY="0" shapeSizeUnit="MM" shapeSVGFile="" shapeSizeType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeRotationType="0" shapeBorderWidth="0" shapeBorderColor="128,128,128,255" shapeOffsetUnit="MM" shapeRadiiY="0" shapeRotation="0" shapeOffsetX="0" shapeJoinStyle="64" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeFillColor="73,73,73,172" shapeSizeX="1" shapeOffsetY="0" shapeRadiiX="0" shapeRadiiUnit="MM" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1">
              <symbol alpha="1" clip_to_extent="1" name="markerSymbol" frame_rate="10" type="marker" force_rhr="0" is_animated="0">
                <data_defined_properties>
          ...
          <text-format wrapChar="###" rightDirectionSymbol=">" addDirectionSymbol="0" placeDirectionSymbol="0" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" useMaxLineLengthForAutoWrap="1" autoWrapLength="30" plussign="0" decimals="3" multilineAlign="1"/>
          <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" repeatDistanceUnits="MM" quadOffset="4" polygonPlacementFlags="2" overrunDistanceUnit="MM" lineAnchorType="0" maxCurvedCharAngleOut="-25" priority="5" maxCurvedCharAngleIn="25" geometryGeneratorType="PointGeometry" placement="1" preserveRotation="1" layerType="PolygonGeometry" offsetUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" placementFlags="10" centroidInside="1" distUnits="MM" allowDegraded="1" overlapHandling="AllowOverlapIfRequired" geometryGenerator="" lineAnchorTextPoint="CenterOfText" lineAnchorPercent="0.5" xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" rotationUnit="AngleDegrees" yOffset="0" geometryGeneratorEnabled="0" rotationAngle="0" offsetType="0" overrunDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0"/>
          <rendering maxNumLabels="2000" obstacleFactor="1" scaleMax="0" scaleMin="0" fontMaxPixelSize="10000" mergeLines="0" labelPerPart="0" obstacle="1" fontLimitPixelSize="0" unplacedVisibility="0" scaleVisibility="0" limitNumLabels="0" obstacleType="0" upsidedownLabels="0" drawLabels="1" fontMinPixelSize="3" zIndex="0" minFeatureSize="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
  ...
  <aliases>
    ...
    <alias name="" field="gemeinde" index="1"/>
    <alias name="" field="flur" index="2"/>
    <alias name="" field="nr" index="3"/>
    <alias name="" field="flaeche" index="4"/>
    <alias name="" field="reinertrag" index="5"/>
    <alias name="" field="mutterrolle" index="6"/>
    <alias name="" field="eigentuemer" index="7"/>
    <alias name="" field="typplain" index="8"/>
    <alias name="" field="typ" index="9"/>
    <alias name="" field="lage" index="10"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="gemeinde" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="flur" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="nr" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="flaeche" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="reinertrag" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="mutterrolle" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="eigentuemer" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="typplain" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="typ" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="lage" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="klasse" unique_strength="0" constraints="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="id" exp="" desc=""/>
    <constraint field="gemeinde" exp="" desc=""/>
    <constraint field="flur" exp="" desc=""/>
    <constraint field="nr" exp="" desc=""/>
    <constraint field="flaeche" exp="" desc=""/>
    <constraint field="reinertrag" exp="" desc=""/>
    <constraint field="mutterrolle" exp="" desc=""/>
    <constraint field="eigentuemer" exp="" desc=""/>
    <constraint field="typplain" exp="" desc=""/>
    <constraint field="typ" exp="" desc=""/>
    <constraint field="lage" exp="" desc=""/>
    <constraint field="klasse" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column name="flaeche" hidden="0" width="-1" type="field"/>
      <column name="mutterrolle" hidden="0" width="-1" type="field"/>
      <column name="eigentuemer" hidden="0" width="-1" type="field"/>
      <column name="typplain" hidden="0" width="-1" type="field"/>
      <column name="lage" hidden="0" width="-1" type="field"/>
      <column name="reinertrag" hidden="0" width="-1" type="field"/>
      <column name="klasse" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorField name="flur" showLabel="1" index="2">
      <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont description="MS Shell Dlg 2,8.14286,-1,5,50,0,0,0,0,0" underline="0" bold="0" italic="0" strikethrough="0" style=""/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField name="nr" showLabel="1" index="3">
      <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont description="MS Shell Dlg 2,8.14286,-1,5,50,0,0,0,0,0" underline="0" bold="0" italic="0" strikethrough="0" style=""/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField name="typ" showLabel="1" index="9">
      <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont description="MS Shell Dlg 2,8.14286,-1,5,50,0,0,0,0,0" underline="0" bold="0" italic="0" strikethrough="0" style=""/>
      </labelStyle>
    </attributeEditorField>
