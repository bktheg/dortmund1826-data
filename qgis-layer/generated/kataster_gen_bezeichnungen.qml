...
<qgis simplifyLocal="1" version="3.28.8-Firenze" minScale="100000000" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyAlgorithm="0" labelsEnabled="1" simplifyDrawingHints="0" symbologyReferenceScale="-1" simplifyDrawingTol="1" simplifyMaxScale="1" readOnly="0">
  ...
  <labeling type="rule-based">
    <rules key="{b4d79514-193f-4b47-b39c-877ff6bf5aae}">
      <rule description="Standard" filter="typ is null or typ=0" key="{9180cca1-4efb-4729-bec2-910368e444cf}" scalemaxdenom="3000" scalemindenom="1">
      ...
      <rule filter="typ is null or typ=0" key="{ee4b73d1-eb37-4396-bb60-34acc8faa8aa}" scalemaxdenom="25000" scalemindenom="3000">
        <settings calloutType="simple">
      ...
      <rule description="Ort" filter="typ=1" key="{4df2bab4-8fbe-4451-9e4c-138bb0ece680}" scalemaxdenom="100000" scalemindenom="1000">
        <settings calloutType="simple">
  ...
  <aliases>
    ...
    <alias name="" field="gemeinde" index="2"/>
    <alias name="" field="flur" index="3"/>
    <alias name="" field="typ" index="4"/>
  </aliases>
  <defaults>
    <default field="id" expression="" applyOnUpdate="0"/>
    <default field="name" expression="" applyOnUpdate="0"/>
    <default field="gemeinde" expression="'schwerte'" applyOnUpdate="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorField name="gemeinde" showLabel="1" index="2">
      <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont description="MS Shell Dlg 2,8.14286,-1,5,50,0,0,0,0,0" underline="0" bold="0" italic="0" strikethrough="0" style=""/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField name="flur" showLabel="1" index="3">
      <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont description="MS Shell Dlg 2,8.14286,-1,5,50,0,0,0,0,0" underline="0" bold="0" italic="0" strikethrough="0" style=""/>
      </labelStyle>
    </attributeEditorField>
